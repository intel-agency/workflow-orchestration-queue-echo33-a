...
|---|---|---|---|
| `.github/workflows/orchestrator-agent.yml` | `workflow-orchestration-queue-echo33-a` | A, D | **DONE** |
| `.github/workflows/prompts/orchestrator-agent-prompt.md` | `workflow-orchestration-queue-echo33-a` | B, D | **DONE** |
| `.github/.labels.json` | `workflow-orchestration-queue-echo33-a` | C, D, L | **DONE** |
